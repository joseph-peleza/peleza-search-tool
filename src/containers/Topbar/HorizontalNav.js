    ...
    return (
      ...
      <Menu
        ...
        <SubMenu className={this.getNavStyleSubMenuClass(navStyle)} key="main"
          ...
          <Menu.Item key="social-media-search">
                <Link to="/social-media-search"><i className="icon icon-widgets"/>
                  <IntlMessages id="socialmedia.socialmediaPage"/></Link>
          </Menu.Item>

          <Menu.Item key="image-search">
                <Link to="/image-search"><i className="icon icon-widgets"/>
                  <IntlMessages id="imagesearch.imagesearchPage"/></Link>
              </Menu.Item>
        </SubMenu>
      </Menu>
